                        ...
                        <tr>
                            <td class="text-center">
                                @if ($user->avatar == null)
                                    <img class="theme-color-default-img img-fluid avatar avatar-50 avatar-rounded"
                                        src="{{ asset('template') }}/assets/images/avatars/01.png" alt="profile">
                                @else
                                    <img class="theme-color-default-img img-fluid avatar avatar-50 avatar-rounded"
                            ...
                            <td>
                                <div class="flex align-items-center list-user-action">
                                    <button class="btn btn-icon btn-soft-warning rounded-pill me-2"
                                        data-bs-toggle="modal" data-bs-target="#UpdateUser-{{ $user->id }}">
                                        <span class="btn-inner" data-bs-toggle="tooltip" data-bs-placement="top"
                                    ...
                                    <button class="btn btn-icon btn-soft-danger rounded-pill">
                                        <span class="btn-inner" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-original-title="Delete">
                                            <svg width="32" viewBox="0 0 24 24" fill="none"
                                                xmlns="http://www.w3.org/2000/svg">
                                                <path opacity="0.4"
